...
def read_csv(filename, tokenizer, max_seq_length, labels_map, textenc='utf-8'):
    '''
    ...
    with open(filename, 'r', encoding=textenc) as f:
...
def main(_):
    ...
    model.fit(
        train_dataset, epochs=FLAGS.num_epochs, 
